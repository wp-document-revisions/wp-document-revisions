...
(function () {
  ...
  WPDocumentRevisions = (function () {
    ...
    WPDocumentRevisions.prototype.secure =
      "https:" === window.location.protocol;

    WPDocumentRevisions.prototype.window =
    ...
    WPDocumentRevisions.prototype.legacyPostDocumentUpload = function (
      attachmentID,
      extension,
    ) {
      ...
      return this.$(".timestamp").each(
        (function (_this) {
          return function () {
            return _this
              .$(_this)
              .text(_this.human_time_diff(_this.$(_this).attr("id")));
          };
        })(this),
      );
    };
    ...
    WPDocumentRevisions.prototype.getDescr = function () {
      ...
      var text =
        iframe.contentWindow.document.getElementById("tinymce").innerHTML;
      if (undefined === text) {
        var content = this.$("#post_content").val();
    ...
    WPDocumentRevisions.prototype.postDocumentUpload = function (
      file,
      attachmentID,
    ) {
      if (
        typeof attachmentID === "string" &&
        attachmentID.indexOf("error") !== -1
      ) {
