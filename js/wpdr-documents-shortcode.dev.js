(function (blocks, element, blockEditor, components, compose, serverSideRender, i18n) {
	...
	const { PanelBody, RadioControl, RangeControl, TextControl, TextareaControl, ToggleControl } =
		wp.components; //WordPress form inputs
			...
			function tax_n(i) {
				...
				if (i == 0) {
					...
					return createElement(
						PanelBody,
						{
							title: __('Taxonomy: ', 'wp-document-revisions') + taxo[0].label,
							initialOpen: false,
						},
						[
				...
				if (i == 1) {
					...
					return createElement(
						PanelBody,
						{
							title: __('Taxonomy: ', 'wp-document-revisions') + taxo[1].label,
							initialOpen: false,
						},
						[
							createElement(RadioControl, {
				...
				if (i == 2) {
					...
					return createElement(
						PanelBody,
						{
							title: __('Taxonomy: ', 'wp-document-revisions') + taxo[2].label,
							initialOpen: false,
						},
						[
							createElement(RadioControl, {
