...
class WP_Document_Revisions_Front_End {
	...
	public function documents_shortcode_blocks() {
		...
		register_block_type(
			...
			array(
				'description'     => __( 'This block provides a list of all documents meeting the selection criteria.', 'wp-document-revisions' ),
		...
		register_block_type(
			...
			array(
				'description'     => __( 'This block provides a list of all the revisions of a selected document.', 'wp-document-revisions' ),
