...
// Using official ServerSideRender component provided by WP core (dependency enqueued in PHP)
	...
	return (
		<Fragment>
			<InspectorControls>
				...
				<PanelBody title={__('Post Status', 'wp-document-revisions')} initialOpen={false}>
					<ToggleControl
				...
				>
					<ToggleControl
						...
						help={__(
							'Display document thumbnails if available',
					...
					<ToggleControl
						...
						help={__(
							'Show direct PDF download link if available',
							'wp-document-revisions'
						)}
					/>
					<ToggleControl
						...
						help={__(
							'Open document links in a new tab/window',
							'wp-document-revisions'
						)}
					/>
				</PanelBody>
