...
For specialized tasks, this repository provides custom agents:
- **@documentation-expert**: Documentation and README maintenance
- **@wordpress-php-expert**: WordPress plugin development
- **@testing-expert**: PHPUnit testing
- **@security-expert**: Security audits and reviews

See [.github/agents/README.md](.github/agents/README.md) for usage details.
