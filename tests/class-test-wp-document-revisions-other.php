...
class Test_WP_Document_Revisions_Other extends Test_Common_WPDR {
	 ...
	 * @return void
	 */
	public function test_pp_support() {
		// ensure EF present.
		include __DIR__ . '/class-pp-custom-status.php';
		global $publishpress;
		$publishpress                         = new stdClass();
		$publishpress->modules                = new stdClass();
		$publishpress->modules->custom_status = new PP_Custom_Status();
