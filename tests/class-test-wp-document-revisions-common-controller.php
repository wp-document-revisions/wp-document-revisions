<?php
/**
 * Common class code functionality for REST Controller.
 *
...
/**
 * WP_Test_REST_Post_Type_Controller_Testcase extended with a few common routines.
 *
 * Note that the ONLY difference with common is the class being extended (not WP_UnitTestCase).
 */
class Test_Common_WPDR_Controller extends WP_Test_REST_Post_Type_Controller_Testcase {
